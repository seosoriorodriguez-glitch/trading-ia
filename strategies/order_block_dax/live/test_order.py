# -*- coding: utf-8 -*-
"""
TEST de operativa del bot ORO: pone una orden STOP de prueba en DE40 y la cancela.
Diagnostica si el broker acepta el filling mode (sospecha: DE40 rechaza RETURN).
Usa magic 999888 (aparte) para NO interferir con el bot en vivo (magic 345683).

Uso (en el VPS):
    python strategies/order_block_dax/live/test_order.py --balance 200000
"""
...
ap.add_argument("--symbol", default="DE40")
...
print("\n" + "="*60)
if ok_mode == "RETURN":
    print("OPERATIVA OK: DE40 acepta RETURN (el que usa el bot). El no-operar es de SEÑAL/sesion, no de ejecucion.")
elif ok_mode:
    print(f"*** ENCONTRADO EL BUG: DE40 NO acepta RETURN, pero SI '{ok_mode}'.")
