...
Version BTC: usa BTC_PARAMS y opera 24/7 sin restriccion horaria.
...
class LiveOBMonitor:
    """Monitor de OBs y senales en tiempo real para BTCUSD."""
    ...
    def check_for_signal(self, balance: float, skip_ob_keys: set = None) -> Optional[Signal]:
        ...
        # Filtro horario (para BTC sessions = always, nunca bloquea)
