# -*- coding: utf-8 -*-
"""
Order Executor - Ejecucion de ordenes en MT5 para la estrategia Order Block London.
"""
...
class OrderExecutor:
    ...
    MAGIC = 345680  # Bot 1 NY=345678 | Bot BTC=345679 | Bot 2 London=345680
    ...
    def execute_signal(self, signal, risk_usd: float, dry_run: bool = False) -> Tuple[bool, dict]:
        ...
        request = {
            ...
            "deviation":   0,
            "magic":       self.MAGIC,
            "comment":     f"OBL_{trade_type}_STOP",  # OBL = Order Block London
