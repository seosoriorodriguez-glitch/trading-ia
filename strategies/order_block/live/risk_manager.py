# -*- coding: utf-8 -*-
"""
FTMO Risk Manager para la estrategia Order Block.
Mismas reglas que pivot_scalping: daily DD 5%, total DD 10%, profit target 10%.
"""
...
class FTMORiskManager:
    ...
    def can_take_trade(self, current_price: dict) -> Tuple[bool, str]:
        ...
        Args:
            current_price: dict con 'spread' (en puntos).
