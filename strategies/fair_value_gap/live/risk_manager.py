# -*- coding: utf-8 -*-
"""
FTMO Risk Manager para la estrategia FVG.
Mismas reglas FTMO que Bot 2 OB London: daily DD 4%, total DD 10%, profit target 10%.
"""
...
class FTMORiskManager:
    """Protecciones FTMO: daily DD, total DD, profit target, spread, weekend."""
    ...
    def can_take_trade(self, current_price: dict) -> Tuple[bool, str]:
        ...
        if daily_dd >= self.max_daily_dd_pct - 0.01:
        ...
        if total_dd >= self.max_total_dd_pct - 0.01:
            self.trading_enabled = False
