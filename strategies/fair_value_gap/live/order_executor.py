# -*- coding: utf-8 -*-
"""
Order Executor - Ejecucion de ordenes en MT5 para la estrategia FVG.
"""
...
class OrderExecutor:
    """Ejecuta ordenes en MT5 a partir de senales del FVG Monitor."""

    MAGIC = 345681  # Bot 1 NY=345678 | Bot BTC=345679 | Bot 2 London=345680 | Bot FVG=345681
    ...
    def execute_signal(self, signal, risk_usd: float, dry_run: bool = False) -> Tuple[bool, dict]:
        ...
        request = {
            ...
            "deviation":   0,
            "magic":       self.MAGIC,
            "comment":     f"FVG_{trade_type}_STOP",
