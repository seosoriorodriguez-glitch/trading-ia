...
Bot Breaker Block — conecta a la instancia MT5_BREAKERBLOCKS.
Soporta M1 y M5 (TF menor y mayor de la estrategia Breaker Block).
"""
...
class LiveDataFeed:
    ...
    def connect(self) -> bool:
        ...
        print(f"MT5 conectado - {self.symbol} ({self.MT5_PATH})")
        return True
