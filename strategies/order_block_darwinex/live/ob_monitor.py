...
Bot DARWINEX — copia independiente. Usa los mismos modulos base de deteccion
(strategies.order_block.backtest.*, compartidos y de solo lectura) con DARWINEX_PARAMS.
...
class LiveOBMonitor:
    ...
    def _build_active_obs(self, all_obs, df_m5, now):
    ...
    def _compute_trend_bias(self, df_m5):
    ...
    def _calculate_sl_tp_limit(self, ob, entry_price):
