# -*- coding: utf-8 -*-
"""
Punto de entrada del Order Block ORO (XAUUSD) Bot.

Uso:
    # Demo / observacion (sin ordenes reales):
    python strategies/order_block_gold/live/run_bot.py --dry-run --balance 200000

    # Free Trial $200k (terminal MT5_FVG por defecto):
    python strategies/order_block_gold/live/run_bot.py --balance 200000

Para detener: crear archivo STOP_GOLD.txt en la raiz del proyecto.

IMPORTANTE:
  - Este bot opera XAUUSD en la instancia MT5_FVG (donde estaba el FVG)
  - Sesion: London 10:00-17:00 UTC+3 | RR 2.5 | riesgo 0.5%
  - Magic number: 345682 (unico; NY=345678, BTC=345679, London US30=345680, Darwinex=345681)
...
from strategies.order_block_gold.live.trading_bot import OrderBlockGoldBot


def main():
    parser = argparse.ArgumentParser(description="Order Block ORO Bot - XAUUSD")
    parser.add_argument("--symbol",   default="XAUUSD",
                        help="Simbolo MT5 (default: XAUUSD)")
